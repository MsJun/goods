            ...
            <li v-for='(item,index) in shopcar' :key='index'>
              <div class="cart-tab-1">
                <div class="cart-item-pic">
                  <img :src="'../../static/img/'+item.prodcutImg" alt="">
                </div>
              ...
              <div class="cart-tab-4">
                <div class="item-price-total">{{(parseFloat(item.prodcutPrice)*parseFloat(item.productNum)) | currency('$')}}</div>
              </div>
        ...
        computed:{
            ...
            subtotal(){
                ...
                this.shopcar.forEach(item=>{
                    b+=item.prodcutPrice*item.productNum
                })
                return b
            },
            // 折扣以后金额
