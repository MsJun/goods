  ...
  <div class="container">
    <div class="checkout-addr">
      ...
      <div class="addr-list-wrap">
        <div class="addr-list">
          <ul>
            <li v-for="(item,index) in addressFilter" :key='index' 
            :class="{'check':flag==item.addressId}" 
            @click='flag=item.addressId,orderId=flag'
            >
              <dl>
                <dt>{{item.userName}}</dt>
              ...
              <div class="addr-opration addr-del" @click='delcurAddress(item.addressId)'>
                <a href="javascript:void(0);" class="addr-del-btn">
                  <svg class="icon icon-del"><use xlink:href="#icon-del"></use></svg>
                </a>
              </div>
              <div class="addr-opration addr-set-default">
                <a href="javascript:void(0);" class="addr-set-default-btn"><i>Set default</i></a>
              </div>
        ...
        <div class="shipping-addr-more">
          <a :class="['addr-more-btn','up-down-btn',{'open':limit!=3}]" href="javascript:void(0);" @click="slideDown">
            more
            <i class="i-up-down">
      ...
      <div class="next-btn-wrap">
          <router-link :to="'/orderConfirm/'+orderId" class="btn btn--m btn--red">
                Next
          </router-link>
      </div>
    </div>
...
<my-dialog :isShow='delAddress' @on-close='delAddressDialog'>
    <div class="dellog">
            <h3>你确认删除这条商品吗？</h3>
    ...
    export default{
        ...
        methods:{
            ...
            delAddressDialog(){
             ...
             // 删除当前的地址的id
            delcurAddress(curAddressId){
                this.addRessId = curAddressId
            ...
            delok(){
                this.delAddress = false
                // 拿到当前删除的地址的id，发送请求删除
                // this.$http.post('/deleaddress',{addressid:this.addRessId})
                // .then(res=>{
                //     // 处理业务逻辑
                // })
            },
